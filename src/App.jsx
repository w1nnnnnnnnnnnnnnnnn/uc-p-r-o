...
export default function App() {
  ...
  function moveProjectToFolder(project, folder) {
    const next = {
      ...projects,
      [project]: {
        ...projects[project],
...
function makeStyles(dark, text) {
  return {
    ...
    grooves: {
      ...
      borderRadius: "50%",
      background:
        "repeating-radial-gradient(circle, rgba(255,255,255,.14) 0px, rgba(0,0,0,.18) 2px, transparent 3px)"
    },
