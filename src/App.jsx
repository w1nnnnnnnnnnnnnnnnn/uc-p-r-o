import React, { useEffect, useRef, useState } from "react"; const [projectProgress, setProjectProgress] = useState(0);
...
export default function App(useEffect(() => {
  const interval = setInterval(() => {
    ...
    setProjectProgress((before + audio.currentTime) / total);
  }, 100);
    ...
    <div style={styles.app}>
      ...
      <div style={styles.sidebar}>
        ...
        <input
          type="color"
          value={vinylColor}
          onChange={(e) => background: dynamicVinyl
